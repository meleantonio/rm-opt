...
% \lstset{ style = Matlab-editor,  basicstyle = \mlttfamily, tabsize = 2 , keywordstyle = \color{cyan}, morekeywords={bsxfun, fmincon, fminunc, fsolve, fzero, optimset, function, end}}

% \lstnewenvironment{MATLAB}[1][,]{\lstset{language = Matlab-pretty, style = Matlab-editor,  keywordstyle = \color{cyan},basicstyle = \mlttfamily, morekeywords={parfor, bsxfun, fmincon, fminunc, fsolve, fzero, optimset, function, end}, float,#1, }}{}


% \newcommand{\inlineMATLAB}[1][,]{\lstinline[language = Matlab-pretty, style = Matlab-editor, keywordstyle = \color{cyan}, basicstyle = \mlttfamily, morekeywords={parfor, bsxfun, fmincon, fminunc, fsolve, fzero, optimset, function, end},#1,]}

\lstset{language=Matlab,
  keywords={break,case,catch,continue,else,elseif,end,for,function,
     global,if,otherwise,persistent,return,switch,try,while, fmincon, fminunc, fsolve, fzero, optimset, function, end},
  basicstyle=\ttfamily,
