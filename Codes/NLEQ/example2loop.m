...
y2 = 1;
beta = .99;
s0_vector = 1:.1:5; % values for s0 


%% LOOP
% allocate memory
c_vector = zeros(2,length(s0_vector)); % a matrix of zeros with two rows (c1, c2 will be stored here)
...
%% plot a graph of the solution as a function of s0
